          ...
          <div className="h-[500px] overflow-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            {authdata.employees.map((elem, idx) => {
              return (
                <div
                  key={idx}
                  className="border-2 border-emerald-500/40 px-8 py-6 rounded-xl flex justify-between items-center shadow-lg hover:scale-[1] transition-all duration-200 mb-4"
                >
